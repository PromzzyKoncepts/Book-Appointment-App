...
reservation1 = Reservation.create(date: '2023-01-04', city: 'Bujumbura', user_id: user1.id, car_id: car1.id)
reservation2 = Reservation.create(date: '2023-01-04', city: 'Danmark', user_id: user2.id, car_id: car2.id)
reservation3 = Reservation.create(date: '2018-01-04', city: 'Nigeria', user_id: user3.id, car_id: car3.id)