...
car4 = Car.create(name: 'Lamborghini', model: 'lambo', description: 'A very luxarious car', price: 13250, user_id: user3.id, image_url: 'https://user-images.githubusercontent.com/65233860/178718657-5d0b9f51-8a97-4045-a14a-c70913891275.png')
